 ...
 * Generated for Laravel 7.9.2 on 2020-05-02 23:19:58.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class Auth
    {
         ...
         *
         * @return \App\Models\Roles\User|null
         * @static
         */
         ...
         *
         * @param mixed $id
         * @return \App\Models\Roles\User|false
         * @static
         */
    ...
    class Cache
    {
         ...
         *
         * @return \Dyrynda\Database\Connection\MySqlConnection
         * @static
         */
    ...
    class DB
    {
        ...
        public static function getSchemaBuilder()
        {
            ...
            /* @var \Dyrynda\Database\Connection\MySqlConnection $instance */
        ...
        {
            //Method inherited from \Illuminate\Database\Connection
            \Dyrynda\Database\Connection\MySqlConnection::resolverFor($driver, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection
            return \Dyrynda\Database\Connection\MySqlConnection::getResolver($driver);
        }
...
namespace App {
    /**
     * @method \Illuminate\Database\Eloquent\Collection|Feedback[]|Feedback create($attributes = [])
     * @method \Illuminate\Database\Eloquent\Collection|Feedback[]|Feedback make($attributes = [])
     */
    class FeedbackFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder
    {
    }
}
...
namespace App\Models {
    /**
     * @method \Illuminate\Database\Eloquent\Collection|ApiMapper[]|ApiMapper create($attributes = [])
     * @method \Illuminate\Database\Eloquent\Collection|ApiMapper[]|ApiMapper make($attributes = [])
     */
    class ApiMapperFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder
    {
    }
}
...
namespace App {
    /**
     * @method \Illuminate\Database\Eloquent\Collection|Note[]|Note create($attributes = [])
     * @method \Illuminate\Database\Eloquent\Collection|Note[]|Note make($attributes = [])
     */
    class NoteFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder
    {
    }
}
