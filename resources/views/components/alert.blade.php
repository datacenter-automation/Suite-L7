...
<div class="flex flex-col">
  ...
  <div class="flex bg-green-lighter max-w-sm mb-4">
    ...
    <div class="w-auto text-grey-darker items-center p-4">
      ...
      <p class="leading-tight">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab beatae consequuntur dolore doloribus eius fugit,
        porro quidem repellat temporibus unde?
      </p>
    </div>
  </div>
  ...
  <div class="flex bg-teal-lighter max-w-sm mb-4">
    ...
    <div class="w-auto text-grey-darker items-center p-4">
      ...
      <p class="leading-tight">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis, labore, voluptatem. Deserunt illum laborum
        maxime?
      </p>
    </div>
  </div>
